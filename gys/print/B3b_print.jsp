...
<pages>
		<table width="257mm">
		  <tr height="20mm">
		   <td width="257mm"><p  font="Simhei" font-size="15pt" align="center">建筑安装工程仪器仪表使用费<%=jsjd%>表（表三）丙</p></td>
		  </tr>
		</table>
		<table width="257mm">
		  <tr height="5mm">
		...
		<table width="257mm">
			<tr height="7mm">
				...
				<td width="79mm" rowspan="2" border="1px solid black" border-top="2px solid black"><p font="Simsun" font-size="9pt" align="center">项目名称</p></td>
				<td width="20mm" rowspan="2" border="1px solid black" border-top="2px solid black"><p font="Simsun" font-size="9pt" align="center">单位</p></td>
				<td width="20mm" rowspan="2" border="1px solid black" border-top="2px solid black"><p font="Simsun" font-size="9pt" align="center">数量</p></td>
				<td width="40mm" rowspan="2" border="1px solid black" border-top="2px solid black"><p font="Simsun" font-size="9pt" align="center">仪表名称</p></td>

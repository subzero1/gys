...
Ga01_de ga01 = new Ga01_de();
String HSql;
ResultObject ro;
Ga01_de list_ga01;
Ga02_clsb list_ga02;
Ga03_glcl list_ga03;
if(request.getParameter("de_bh") != null){
	QueryBuilder queryBuilder9 = new HibernateQueryBuilder(Ga01_de.class);
	queryBuilder9.eq("bh",request.getParameter("de_bh"));
	ResultObject ro9 = queryService.search(queryBuilder9);
	if(ro9.next()){
		ga01 = (Ga01_de) ro9.get(Ga01_de.class.getName());
	}
        ...
        <tr>
	        ...
	        <table border="0" cellpadding="3" cellspacing="0" style="border-collapse:collapse;height:14px;" width="95%">
	        		...
	        		<tr>
	        			...
	        			<td><input type="text" name="Ga01_de.BH" value="<%=StringFormatUtil.format(ga01.getBh())%>" class="td-input"></td>
    ...
    <div style="width:98%;background:#ffffff">
      ...
      <div id="tab1" style="display:block;">
        <table name="tab1" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;background:#ffffff" id="form-list">
          <tr>
            ...
            <td align="center">主材名称</td>
            <td width="200" align="center">型号规格</td>
            <td width="50" align="center">单位</td>
            <td width="90" align="center">材料数量</td>
          </tr>
          <%
      	  HSql = "select ga01,ga02,ga03 from Ga01_de ga01,Ga02_clsb ga02,Ga03_glcl ga03 where ga01.id = ga03.de_id and ga02.id = ga03.cl_id and ga02.lb = 'ZC' and ga01.id = " + ga01_id;
      ...
      <div  id="tab2" style="display:none;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;background:#ffffff" id="form-list">
          <tr>
            ...
            <td align="center">机械名称</td>
            <td width="120" align="center">型号规格</td>
            <td width="50" align="center">单位</td>
            <td width="80" align="center">材料数量</td>
          </tr>
          <%
      	  HSql = "select ga01,ga02,ga03 from Ga01_de ga01,Ga02_clsb ga02,Ga03_glcl ga03 where ga01.id = ga03.de_id and ga02.id = ga03.cl_id and ga02.lb = 'JX' and ga01.id = " + ga01_id;
      	  ro = queryService.search(HSql);
      	  %>
          <%
          i = 0;
      ...
      <div  id="tab3" style="display:none;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;background:#ffffff" id="form-list">
          <tr>
            ...
            <td align="center">仪表名称</td>
            <td width="120" align="center">型号规格</td>
            <td width="50" align="center">单位</td>
            <td width="80" align="center">材料数量</td>
          </tr>
          <%
      	  HSql = "select ga01,ga02,ga03 from Ga01_de ga01,Ga02_clsb ga02,Ga03_glcl ga03 where ga01.id = ga03.de_id and ga02.id = ga03.cl_id and ga02.lb = 'YB' and ga01.id = " + ga01_id;
      	  ro = queryService.search(HSql);
      	  %>
          <%
          i = 0;
      ...
      <div  id="tab4" style="display:none;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;background:#ffffff" id="form-list">
          ...
          <%
      	  HSql = "select ga01,ga02,ga03 from Ga01_de ga01,Ga02_clsb ga02,Ga03_glcl ga03 where ga01.id = ga03.de_id and ga02.id = ga03.cl_id and ga02.lb = 'SB' and ga01.id = " + ga01_id;
      	  ro = queryService.search(HSql);
      	  %>
          <%
          i = 0;
          while(ro.next() || i < 6){
	          ...
	          <tr onDblClick="javascript:deleteRow(this);">
	            ...
	            <td align="center"><%=StringFormatUtil.format(list_ga02.getDw())%></td>
	            <td>
	            	<input type="text" name="Ga03_glcl.CLSL" value="<%=NumberFormatUtil.roundToString(list_ga03.getClsl().toString(),3)%>" class="td-input-noborder">
	            	<input type="hidden" name="Ga03_glcl.XH" value="<%=StringFormatUtil.format(list_ga03.getXh())%>">
	            	<input type="hidden" name="Ga03_glcl.CL_ID" value="<%=list_ga03.getCl_id()%>">
	            	<input type="hidden" name="Ga03_glcl.DE_ID" value="<%=list_ga03.getDe_id()%>">
	            	<input type="hidden" name="Ga03_glcl.ID" value="<%=list_ga03.getId()%>">

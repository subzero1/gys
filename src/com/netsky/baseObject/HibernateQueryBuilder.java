...
public class HibernateQueryBuilder implements QueryBuilder {
	...
	public void notlike(String propertyName, Object value) {
		if (isNotEmpty(value))
			detachedCriteria.add(Restrictions.or(Restrictions.not(Restrictions.like(propertyName, value)), Restrictions.isNull(propertyName)));
	}
	...
	public void notlike(String propertyName, String value, MatchMode matchMode) {
		if (isNotEmpty(value))
			detachedCriteria.add(Restrictions.or(Restrictions.not(Restrictions.like(propertyName, value, matchMode)), Restrictions.isNull(propertyName)));
	}
